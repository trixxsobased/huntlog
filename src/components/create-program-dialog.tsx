  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="bg-[#111111] border-[#1f1f1f] sm:rounded-sm">
        <DialogHeader>
          <DialogTitle className="font-bold">Add New Program</DialogTitle>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          <div className="space-y-1.5">
            ...
            <Input id="name" name="name" required placeholder="e.g. Uber" className="h-9 rounded-sm border-[#1f1f1f] bg-transparent focus-visible:ring-1 focus-visible:ring-violet-500" />
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            <Input id="url" name="url" placeholder="https://hackerone.com/uber" className="h-9 rounded-sm border-[#1f1f1f] bg-transparent focus-visible:ring-1 focus-visible:ring-violet-500" />
          </div>
